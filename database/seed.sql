...
INSERT INTO "EmployeeHistory" ("date_start", "date_end", "salary", "role", "employeeId", "branchId") VALUES
  ('1999-01-01', '2005-12-31', 2500.00, (SELECT "id" FROM "Rol" WHERE "description" = 'Jefe de Marketing'), '0752d788-e0c5-4ad0-8dfb-f7e40a366748', '066724c7-1f4a-4992-8b55-6c4946bba009'),
  ('2002-03-01', '2004-06-30', 2200.00, (SELECT "id" FROM "Rol" WHERE "description" = 'Jefe de Frutas y Verduras'), '180dd597-d996-4bc9-8ec1-b1f85e46b05d', '13386c41-0c80-48f3-8c06-f79788b1d224'),
  ('2005-07-01', '2010-05-15', 3000.00, (SELECT "id" FROM "Rol" WHERE "description" = 'Gerente de Tienda'), '23b20ce8-150b-47a3-b69a-bb4a4876d4a3', '1a27cdd2-a522-4286-a933-d86b4be9a362'),
  ('2010-09-15', '2015-11-30', 2800.00, (SELECT "id" FROM "Rol" WHERE "description" = 'Especialista en Atención al Cliente'), '305c851c-7cc0-4438-870c-92b19c8a781f', '36a6270f-9654-4e5f-aae5-b74702b7d75f'),
  ('2015-02-15', '2018-12-31', 2600.00, (SELECT "id" FROM "Rol" WHERE "description" = 'Cajero'), '62fceb2d-e71e-4163-826b-573503b4277a', '3ee0aca9-8d74-4cf4-b7f2-4bc8230c4b57'),
  ('2016-05-01', '2019-10-15', 2700.00, (SELECT "id" FROM "Rol" WHERE "description" = 'Jefe de Carnicería'), '768c3809-ba88-4fc3-99db-cfd67f2a21ed', '4eba5f09-6a5f-471a-b117-36af2c70079d'),
  ('2017-08-10', '2020-11-30', 2300.00, (SELECT "id" FROM "Rol" WHERE "description" = 'Subgerente de Tienda'), '836924a1-c4ad-4ef4-b138-467ab0bda514', '58466b8f-c950-437d-b7d6-4a31d2036318'),
  ('2019-12-01', '2021-05-20', 2900.00, (SELECT "id" FROM "Rol" WHERE "description" = 'Jefe de Limpieza'), 'a55601e1-98ad-4ff1-9c9d-748547f8a79f', '643b9dfd-263c-4109-8c35-256efced4509'),
  ('2020-03-01', null, 2600.00, (SELECT "id" FROM "Rol" WHERE "description" = 'Supervisor de Ventas'), 'c684a12f-f051-4c90-8c97-0372ce9fd3eb', '6b773fb5-4031-4458-b6a9-ece09500fecd'),
  ('2020-05-15', null, 3100.00, (SELECT "id" FROM "Rol" WHERE "description" = 'Especialista en Compras'), 'c6f0da21-ac9b-488f-a339-73454549e621', '96772540-3787-4e83-b5a8-1e3f0ec79d05'),
  ('2018-06-20', '2021-12-31', 2400.00, (SELECT "id" FROM "Rol" WHERE "description" = 'Reponedor'), 'd57aa8ac-a693-4ff7-a61b-d4d9895a54c6', 'ba03f2fd-31ed-43d7-8644-389bd8a7125a'),
  ('2019-08-10', '2022-07-15', 2700.00, (SELECT "id" FROM "Rol" WHERE "description" = 'Cajero'), 'e2a8a7e6-1125-4425-ab62-8c8b1b41b272', 'eb2985fd-3e90-4a84-ba9d-87d2789ac82d'),
  ('2020-11-05', '2023-02-28', 2800.00, (SELECT "id" FROM "Rol" WHERE "description" = 'Jefe de Panadería'), 'ec11edd1-8d92-4552-bdb5-8562c9e59612', '970690aa-c820-4ef4-ad82-ac5830ea3fda'),
  ('2021-04-15', null, 2600.00, (SELECT "id" FROM "Rol" WHERE "description" = 'Asistente de Ventas'), 'a70c9976-2c69-4219-8e9d-a26ba26da1d2', 'ba03f2fd-31ed-43d7-8644-389bd8a7125a');

----------------------------------------
-- * Inserts para "Absence"
----------------------------------------
INSERT INTO "Absence" ("date", "justified", "date_start") VALUES
  ('2000-07-15', 'Vacaciones', '1999-01-01'),
  ('2003-09-20', 'Enfermedad', '2002-03-01'),
  ('2006-10-05', 'Otro', '2005-07-01'),
  ('2012-03-15', 'Enfermedad', '2010-09-15'),
  ('2017-05-10', 'Vacaciones', '2015-02-15'),
  ('2018-08-25', 'Otro', '2016-05-01'),
  ('2019-11-12', 'Enfermedad', '2017-08-10'),
  ('2022-02-07', 'Vacaciones', '2018-06-20'),
  ('2023-06-15', 'Otro', '2019-08-10'),
  ('2024-09-20', 'Enfermedad', '2019-12-01'),
  ('2025-12-25', 'Vacaciones', '2020-03-01'),
  ('2026-04-30', 'Otro', '2020-05-15');
...
INSERT INTO "Order" ("id", "date", "taxes", "discount", "subtotal", "clientId", "branch") VALUES
  ('1f197f20-0dfb-4815-90b0-d4f6504a3cd0', '2023-01-10', 10.00, 5.00, 250.00, '040e0e89-c38d-4cc8-87f6-d7f1a466ef67', '066724c7-1f4a-4992-8b55-6c4946bba009'),
  ('b21c1a0d-6c0b-4f05-87a9-06b6a5f3c3df', '2023-01-15', 5.00, 10.00, 150.00, '30d60bd6-7152-4fe6-88ba-c9a4ca5056b8', '13386c41-0c80-48f3-8c06-f79788b1d224'),
  ('573a34a1-1ea1-4a0b-81e9-ea998e732ca3', '2023-02-01', 12.00, 6.00, 300.00, '6ba454b3-19a7-43fb-8289-ddb9272072e8', '1a27cdd2-a522-4286-a933-d86b4be9a362'),
  ('1c4d63dc-8ef4-4b20-85e2-2c0bc6362e4a', '2023-02-10', 8.00, 4.00, 200.00, '71d2c191-d1ae-4b41-b661-722b5441c447', '36a6270f-9654-4e5f-aae5-b74702b7d75f'),
  ('be32d8e2-841d-4ec7-879c-95c398e22fc3', '2023-02-20', 7.20, 3.60, 180.00, '7b6da078-6a46-4ca5-be8e-f571e755ddd7', '3ee0aca9-8d74-4cf4-b7f2-4bc8230c4b57'),
  ('f7e2bfec-6f3c-4ab2-8c71-e8c8b3cb47d9', '2023-03-05', 8.80, 4.40, 220.00, '7f5eee41-f134-474c-a9f7-6fe565313003', '4eba5f09-6a5f-471a-b117-36af2c70079d'),
  ('77b54183-86b4-4753-8f41-2e82543a26f2', '2023-03-10', 6.80, 3.40, 170.00, '87136d57-e8b9-4226-a4e2-523b80220e25', '58466b8f-c950-437d-b7d6-4a31d2036318'),
  ('d1f2de35-6e78-4be5-8d45-711bd8b1c6f2', '2023-03-15', 10.80, 5.40, 270.00, '91043236-48a4-42ab-b477-380965eb24a8', '643b9dfd-263c-4109-8c35-256efced4509'),
  ('1e82d8fe-9e1b-4c0d-894e-d6e4b33b1c42', '2023-04-01', 12.80, 6.40, 320.00, '92e7974b-08fd-46ae-b486-d9d6e7d05b98', '96772540-3787-4e83-b5a8-1e3f0ec79d05'),
  ('b5f4c3bc-4a7f-4bfa-8d75-d9e6b44b4f3b', '2023-04-10', 9.60, 4.80, 240.00, '97341fc5-832f-4ad5-a709-db66988bc928', 'ba03f2fd-31ed-43d7-8644-389bd8a7125a'),
  ('3a7b9c57-7e9b-4cae-89e7-d1d6c3a3b2e5', '2023-04-20', 8.00, 4.00, 200.00, 'a6692de2-4cdd-4148-895d-7744a35e5b0c', 'eb2985fd-3e90-4a84-ba9d-87d2789ac82d');
